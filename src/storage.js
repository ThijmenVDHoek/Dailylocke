...
(function () {
  ...
  // ----------------------------------------------------------- PROFILE -----
  // `name` is part of the profile rather than a separate key on purpose: it
  // is per-player and outlives every run, and must ride along in a backup so
  // restoring on a new device keeps the trainer's identity.

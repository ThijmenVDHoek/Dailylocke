...
(function () {
  ...
  var LESSONS = [
    ...
    { id: 'mart', where: 'items', title: 'Open the Mart',
      say: 'I keep the right Ball tier and Full Restores in stock, plus any stones your party can use.',
    ...
    { id: 'held', where: 'training', title: 'Receive a held item',
      say: 'A held item works every turn without costing a move. One is granted to your Bag after every victory.',
      body: 'Give the <b>held item</b> from your Bag to the Pokemon that suits it.' },
    { id: 'evolve', where: 'training', title: 'Evolve your starter',
      ...
      body: 'The <b>Rare Candy</b> from your battle reward is in your Bag. Use it on your team.' },
